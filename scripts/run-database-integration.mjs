...
const result = spawnSync(
  ...
  [
    ...
    'apps/api/src/services/application-quality.integration.test.ts',
    'apps/api/src/services/job-matching.integration.test.ts',
    'apps/api/src/services/lever-application.test.ts',
    'apps/api/src/services/resume-tailoring.integration.test.ts',
    ...
    'apps/api/src/services/email-sync.integration.test.ts',
    'apps/api/src/services/email-connectors.integration.test.ts',
    'apps/api/src/services/durable-credentials.integration.test.ts',
    'apps/api/src/services/email-oauth.integration.test.ts',
    'apps/api/src/services/automation-alert-outbox.integration.test.ts',
